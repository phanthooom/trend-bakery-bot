    ...
    <div className="flex flex-col min-h-screen bg-gray-50 pb-24">
      ...
      <div className="mx-4 mt-4 bg-white rounded-2xl p-4 flex items-center gap-3 shadow-sm">
        ...
        <div className="flex-1 min-w-0">
          <div className="font-bold text-gray-900 truncate text-base">
            {tgUser ? `${tgUser.first_name ?? ''} ${tgUser.last_name ?? ''}`.trim() : t('guest')}
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="font-bold text-sm">{t('controlPanel')}</p>
                <p className="text-white/70 text-xs">{t('controlPanelDesc')}</p>
              </div>
            </div>
      ...
      <div className="mx-4 mt-3 bg-white rounded-2xl overflow-hidden shadow-sm divide-y divide-gray-50">
        ...
        <SettingsRow
          ...
          label={t('delivery')}
          sublabel={deliveryType === 'delivery' ? t('deliveryCourier') : t('pickup')}
          right={
            <div className="flex bg-gray-100 rounded-xl p-0.5 gap-0.5">
              <button
        ...
        <SettingsRow
          ...
          sublabel={address?.street ?? t('addressNotSet')}
      ...
      {/* App version */}
      <p className="text-center text-xs text-gray-300 mt-6">{t('appVersion')}</p>
    </div>
  )
}
